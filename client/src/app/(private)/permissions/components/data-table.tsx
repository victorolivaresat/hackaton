...
import { DataTableViewOptions } from "@/components/shared/datatable/view-options";
import { KeyRound } from "lucide-react";
import type { Permission } from "@/types/permission";

interface DataTableProps<TValue> {
  columns: ColumnDef<Permission, TValue>[];
  data: Permission[];
  ...
  return (
    <div className="rounded-md border p-4 shadow-sm">
      <div className="flex items-center mb-6 min-h-[40px] gap-4">
        <KeyRound className="text-primary mr-2" size={28} />
        <h2 className="text-xl font-bold leading-none">Gestión de Permisos</h2>
